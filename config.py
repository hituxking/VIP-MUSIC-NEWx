...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/hituxking/VIP-MUSIC-NEWx",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/VipmusicXsupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/primeabhay")
